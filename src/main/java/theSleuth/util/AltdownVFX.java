...
public class AltdownVFX extends AbstractGameEffect {
    ...
    public AltdownVFX(AbstractCreature ac) {
        if (imgs == null) {
            imgs = new Texture[4];
            imgs[0] = TextureLoader.getTexture(SleuthMod.makeVFXPath("Altdown1.png"));
            imgs[1] = TextureLoader.getTexture(SleuthMod.makeVFXPath("Altdown2.png"));
            imgs[2] = TextureLoader.getTexture(SleuthMod.makeVFXPath("Altdown3.png"));
            imgs[3] = TextureLoader.getTexture(SleuthMod.makeVFXPath("Altdown4.png"));
        }
        this.ac = ac;
