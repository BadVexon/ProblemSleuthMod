...
public class GambitStuff extends AbstractGameEffect {
    private float x;
    private float y;
    ...
    public GambitStuff(float x, float y) {
        this.x = x - 15F;
        this.y = y - 15F;
        this.color = Color.WHITE.cpy();
        imgs = new Texture[12];
        imgs[0] = TextureLoader.getTexture(SleuthMod.makeVFXPath("schema1.png"));
        imgs[1] = TextureLoader.getTexture(SleuthMod.makeVFXPath("schema2.png"));
        imgs[2] = TextureLoader.getTexture(SleuthMod.makeVFXPath("schema3.png"));
        imgs[3] = TextureLoader.getTexture(SleuthMod.makeVFXPath("schema4.png"));
        imgs[4] = TextureLoader.getTexture(SleuthMod.makeVFXPath("schema5.png"));
        imgs[5] = TextureLoader.getTexture(SleuthMod.makeVFXPath("schema6.png"));
        imgs[6] = TextureLoader.getTexture(SleuthMod.makeVFXPath("altschema1.png"));
        imgs[7] = TextureLoader.getTexture(SleuthMod.makeVFXPath("altschema2.png"));
        imgs[8] = TextureLoader.getTexture(SleuthMod.makeVFXPath("altschema3.png"));
        imgs[9] = TextureLoader.getTexture(SleuthMod.makeVFXPath("altschema4.png"));
        imgs[10] = TextureLoader.getTexture(SleuthMod.makeVFXPath("altschema5.png"));
        imgs[11] = TextureLoader.getTexture(SleuthMod.makeVFXPath("altschema6.png"));
        this.duration = 0.6F;
