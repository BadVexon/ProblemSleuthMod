...
public class TreatyCurvies extends AbstractGameEffect {
    private Vector2 pos;
    private float speed;
    ...
    public TreatyCurvies(float x, float y, boolean renderBehind) {
        ...
        this.speed = MathUtils.random(300.0F, 600.0F) * Settings.scale;
        this.speedStart = this.speed;
        this.speedTarget = MathUtils.random(100.0F, 200.0F) * Settings.scale;
        this.color = new Color(0.309F, 0.549F, 0.933F, 1.0F);
        this.renderBehind = false;
        this.rotation = MathUtils.random(360.0F);
        this.waveIntensity = MathUtils.random(10.0F, 30.0F);
        this.waveSpeed = MathUtils.random(-15.0F, 15.0F);
        this.speedTarget = MathUtils.random(0.1F, 0.5F);
    }

    public TreatyCurvies(float x, float y) {
        this(x, y, true);
    }
