...
public class MattressCurvy extends AbstractGameEffect {
    private Vector2 pos;
    private float speed;
    ...
    public MattressCurvy(float x, float y, boolean renderBehind) {
        ...
        if (MathUtils.randomBoolean()) {
            this.color = new Color(0.247F, 0.003F, 0.392F, 1.0F);
        } else {
            this.color = new Color(0.576F, 0F, 0.905F, 1.0F);
        }
    ...
    public MattressCurvy(float x, float y) {
        this(x, y, true);
    }
