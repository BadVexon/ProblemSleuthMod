...
public class MidnightCurvy extends AbstractGameEffect {
    private Vector2 pos;
    private float speed;
    ...
    public MidnightCurvy(float x, float y, Color color, boolean renderBehind) {
    ...
    public MidnightCurvy(float x, float y) {
