...
public class CandyCaneVFX extends AbstractGameEffect {
    ...
    public CandyCaneVFX(AbstractCreature ac) {
        if (imgs == null) {
            imgs = new Texture[5];
            imgs[0] = TextureLoader.getTexture(SleuthMod.makeVFXPath("CandyCane1.png"));
            imgs[1] = TextureLoader.getTexture(SleuthMod.makeVFXPath("CandyCane2.png"));
            imgs[2] = TextureLoader.getTexture(SleuthMod.makeVFXPath("CandyCane3.png"));
            imgs[3] = TextureLoader.getTexture(SleuthMod.makeVFXPath("CandyCane4.png"));
            imgs[4] = TextureLoader.getTexture(SleuthMod.makeVFXPath("CandyCane5.png"));
        }
        this.ac = ac;
    ...
    public void render(SpriteBatch sb) {
        ...
        } else if (framenum > 0.05 && framenum <= 0.15) {
        ...
        } else if (framenum > 0.1 && framenum <= 0.45) {
        ...
        } else if (framenum > 0.45 && framenum <= 0.55) {
        ...
        } else if (framenum > 0.55 && framenum <= 0.6) {
            sb.draw(imgs[4], ac.hb.cX - imgs[4].getWidth() / 2F, ac.hb.cY - imgs[4].getHeight() / 2F, imgs[4].getWidth() / 2F, imgs[4].getHeight() / 2F, imgs[4].getWidth(), imgs[4].getHeight(), this.scale, this.scale, this.rotation, 0, 0, imgs[4].getWidth(), imgs[4].getHeight(), false, false);
        }
    }
