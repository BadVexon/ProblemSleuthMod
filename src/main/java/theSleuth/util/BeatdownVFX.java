...
public class BeatdownVFX extends AbstractGameEffect {
    ...
    public BeatdownVFX(AbstractCreature ac) {
        if (imgs == null) {
            imgs = new Texture[5];
            imgs[0] = TextureLoader.getTexture(SleuthMod.makeVFXPath("Beatdown1.png"));
            imgs[1] = TextureLoader.getTexture(SleuthMod.makeVFXPath("Beatdown2.png"));
            imgs[2] = TextureLoader.getTexture(SleuthMod.makeVFXPath("Beatdown3.png"));
            imgs[3] = TextureLoader.getTexture(SleuthMod.makeVFXPath("Beatdown4.png"));
            imgs[4] = TextureLoader.getTexture(SleuthMod.makeVFXPath("Beatdown5.png"));
        }
        this.ac = ac;
