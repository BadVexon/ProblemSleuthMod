...
import theSleuth.actions.WhiskeyRetainAction2;
...
public class FlaskOfWhiskey extends AbstractSleuthCard {


    public static final String ID = SleuthMod.makeID("FlaskOfWhiskey");
    public static final String IMG = makeCardPath("Moonshine.png");
    ...
    public void realUse(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new WhiskeyRetainAction2());
    }
