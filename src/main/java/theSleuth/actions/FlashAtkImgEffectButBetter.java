...
public class FlashAtkImgEffectButBetter extends AbstractGameEffect {
    ...
    public FlashAtkImgEffectButBetter(float x, float y, AttackEffect effect, boolean mute) {
    ...
    public FlashAtkImgEffectButBetter(float x, float y, AttackEffect effect) {
    ...
    private void playSound(AttackEffect effect) {
        switch (effect) {
            case SHIELD:
                this.playBlockSound();
                break;
