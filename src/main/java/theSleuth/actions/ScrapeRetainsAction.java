...
public class ScrapeRetainsAction extends AbstractGameAction {
    ...
    public ScrapeRetainsAction(AbstractCreature source, int amount, boolean endTurnDraw) {
    ...
    public ScrapeRetainsAction(AbstractCreature source, int amount) {
                ...
                if (deckSize + discardSize == 0) {
                    ...
                    if (!this.shuffleCheck) {
                        if (this.amount > deckSize) {
                            ...
                            AbstractDungeon.actionManager.addToTop(new ScrapeRetainsAction(AbstractDungeon.player, tmp));
                            AbstractDungeon.actionManager.addToTop(new EmptyDeckShuffleAction());
                            if (deckSize != 0) {
                                AbstractDungeon.actionManager.addToTop(new ScrapeRetainsAction(AbstractDungeon.player, deckSize));
                            }
